...
const Header = () => {
  return (
    <header className="relative min-h-[100dvh] w-full flex flex-col justify-center items-center text-white bg-gradient-to-tr from-[#0E0B1D] to-[#322E99] p-8 px-4 md:px-12 lg:px-[5.3125rem] overflow-hidden">
      <Hero />
